...
public class WindowsAzureStorageServices extends WindowsAzureServiceImpl {
	...
	WACommonException, URISyntaxException, RestAPIException, InterruptedException, CommandLineException, ExecutionException, IOException {

		String url = PreferenceSetUtil.getSelectedBlobServiceURL(storageAccount)
				                      .concat(PUT_BLOB).replace(STRG_CONTAINER, container).concat("/" + blobName);
