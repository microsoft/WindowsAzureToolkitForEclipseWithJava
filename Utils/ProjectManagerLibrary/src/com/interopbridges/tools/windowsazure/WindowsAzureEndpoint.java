...
//            }
     ...
     * @throws WindowsAzureInvalidProjectOperationException
     */
    public void setProtocol(String protocol) throws WindowsAzureInvalidProjectOperationException {
        if ((protocol == null) || (protocol.isEmpty())) {
            throw new IllegalArgumentException(WindowsAzureConstants.EXCP_EMPTY_PROTOCOL);
        }
        
        try {
        	 Node epNode = getThisEndPointNode();
        	 epNode.getAttributes().getNamedItem("protocol").setNodeValue(protocol);
     ...
     * @throws WindowsAzureInvalidProjectOperationException
     */
    public void setCertificate(String certificate) throws WindowsAzureInvalidProjectOperationException {
    
    	if ((certificate == null) || (certificate.isEmpty())) {
            throw new IllegalArgumentException(WindowsAzureConstants.EXCP_EMPTY_CERT);
        }
     ...
     * @throws WindowsAzureInvalidProjectOperationException
     */
    public void removeAttribute(String attributeName) throws WindowsAzureInvalidProjectOperationException {
        try {
        		Node epNode 	= getThisEndPointNode();
    ...
    public void setPrivatePort(String endPointPort)
        ...
        if (getEndPointType().equals(WindowsAzureEndpointType.Input)||
            ...
            /*
             * no child node i.e. (auto) was selected previously
             * and if again auto is coming then dont do any thing.
             */
        ...
        try {
            ...
            if (getEndPointType() != type) {
                ...
                if (type == WindowsAzureEndpointType.Input) {
                    ...
                    eleInputNode.setAttribute("localPort", getPrivatePortWrapper());
                ...
                if (type == WindowsAzureEndpointType.Internal) {
                    ...
                    if (priPort != null && !priPort.isEmpty() && !priPort.equals("*")) {
                    	Element eleFixedPort = doc.createElement("FixedPort");
                    	eleFixedPort.setAttribute("port", getPrivatePortWrapper());
               ...
               if( type == WindowsAzureEndpointType.InstanceInput) {
                   ...
                   eleInstanceNode.setAttribute("localPort", getPrivatePortWrapper());
    ...
    public boolean isStickySessionEndpoint() throws WindowsAzureInvalidProjectOperationException {
    	...
    	try {
    		...
    		if (!stcEndptName.isEmpty()
    				...
    				&& (getName().equalsIgnoreCase(stcEndptName)
    						|| getName().equalsIgnoreCase(stcIntEndptName))) {
    ...
    public boolean isSSLEndpoint() throws WindowsAzureInvalidProjectOperationException {
    	...
    	try {
    		...
    		if (!sslEndptName.isEmpty()
    				...
    				&& (getName().equalsIgnoreCase(sslEndptName)
    						|| getName().equalsIgnoreCase(sslIntEndptName))) {
