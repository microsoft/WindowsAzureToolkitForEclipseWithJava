...
final class WindowsAzureConstants_v16 {

    private WindowsAzureConstants_v16() {}
    public static final String SERVICE_NAME = "/ServiceDefinition/@name";
    public static final String WINAZURE_PACKAGE = "/project/target/windowsazurepackage";
    ...
    public static final String DBG_ENV_VAR = "_JAVA_OPTIONS";
    ...
    public static final int MAX_LS_SIZE_EXTRALARGE = 2088960;
  	...
  	public static final String SAMPLE_PATH = "/upgrade/Samples/";
    public static final String ST_CUSTOM = "startup_Custom.txt";
    public static final String ST_TOMCAT = "startupApacheTomcat7.txt";
    ...
    public static final String ST_JETTY = "startupJetty7.txt";

    public static final String ST_CUSTOM_PATH = SAMPLE_PATH + ST_CUSTOM;
    public static final String ST_TOMCAT_PATH = SAMPLE_PATH + ST_TOMCAT;
    public static final String ST_GLASSFISH_PATH = SAMPLE_PATH + ST_GLASSFISH;
    public static final String ST_JBOSS6_PATH = SAMPLE_PATH + ST_JBOSS6;
    public static final String ST_JBOSS7_PATH = SAMPLE_PATH + ST_JBOSS7;
    public static final String ST_JETTY_PATH = SAMPLE_PATH + ST_JETTY;
    ...
    public static final String EXCP_SET_INPUT_LOCAL_PORT = "Exception occured while setting input local port";
